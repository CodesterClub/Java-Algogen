...
## Who are the needy:
As of 12th Jan of 2021, I've ([OogleGlu](https://github.com/OogleGlu)) just recovered from writing about 20 algorithms 
for my [ISC-Computer-Project](https://github.com/OogleGlu/ISC-Computer-Project) repository (the .algo files). Why? Coz I am lazy 
